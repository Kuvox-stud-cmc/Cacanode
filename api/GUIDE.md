...
| `billing` | Plans, subscriptions, payment orders, PayOS webhooks, entitlements, quotas, and usage counters | `BillingModuleApi`, `BillingQuotaApi`, API-owned billing DTOs and `MessageQuotaExceededException` | `usage_metrics`, `billing_subscriptions`, `billing_payment_orders`, `billing_webhook_events`, `billing_order_code_seq` |
