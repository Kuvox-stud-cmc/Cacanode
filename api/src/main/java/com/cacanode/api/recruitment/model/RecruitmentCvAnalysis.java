...
public class RecruitmentCvAnalysis {
    ...
    @Column(name="contract_version",nullable=false,updatable=false) private String contractVersion="1.1";
    @Column(name="analysis_revision",nullable=false,updatable=false) private int analysisRevision=1;
    @Column(name="refresh_request_id",updatable=false) private UUID refreshRequestId;
    ...
    @Column(name="fit_score_percent") private Integer fitScorePercent;
    @Column(name="fit_confidence",length=10) private String fitConfidence;
    @Column(name="fit_explanation",columnDefinition="text") private String fitExplanation;
    @JdbcTypeCode(SqlTypes.JSON) @Column(nullable=false,columnDefinition="jsonb") private String strengths="[]";
    @JdbcTypeCode(SqlTypes.JSON) @Column(nullable=false,columnDefinition="jsonb") private String gaps="[]";
