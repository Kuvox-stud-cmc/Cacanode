...
from app.core.cache import CacheReadStatus, CacheStore
from app.core.concurrent_loads import AUTHORITATIVE_LOAD_TRACKER, ConcurrentLoadTracker
...
def retrieval_configuration_fingerprint(settings: Settings) -> str:
    configuration = {
    ...
    async def retrieve(
        ...
        *,
        ...
        try:
            ...
            try:
                revision = await self._revision_store.current_revision(tenant_id, knowledge_base_id)
